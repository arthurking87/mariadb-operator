...
| `autoServerId` _boolean_ | AutoServerID determines whether the operator should auto-compute server_id from the Pod ordinal and ServerIDStartIndex.<br />It is enabled by default. Disable it if you manage server_id externally. |  |  |
