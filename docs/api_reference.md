...
| `revisionHistoryLimit` _integer_ | RevisionHistoryLimit is the number of old ControllerRevisions retained by the StatefulSet for rollback.<br />If unset, it defaults to the Kubernetes API default (10). |  |  |
