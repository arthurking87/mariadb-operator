...
var (
	// ReplicaConnectionName is the named replication channel used for intra-cluster replication.
	ReplicaConnectionName = "mariadb-operator"
	// MultiClusterReplicaConnectionName is the named replication channel used for cross-cluster replication.
